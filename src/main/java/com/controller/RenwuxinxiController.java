...
public class RenwuxinxiController {
    ...
    public R page(@RequestParam Map<String, Object> params,RenwuxinxiEntity renwuxinxi, 
		...
		if(tableName.equals("jingli")) {
			renwuxinxi.setJingligonghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("yuangong")) {
			renwuxinxi.setYuangonggonghao((String)request.getSession().getAttribute("username"));
		}
