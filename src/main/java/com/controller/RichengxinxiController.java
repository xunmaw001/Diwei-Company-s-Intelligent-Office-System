...
public class RichengxinxiController {
    ...
    public R page(@RequestParam Map<String, Object> params,RichengxinxiEntity richengxinxi, 
		...
		if(tableName.equals("jingli")) {
			richengxinxi.setJingligonghao((String)request.getSession().getAttribute("username"));
		}
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<RichengxinxiEntity> wrapper = new EntityWrapper<RichengxinxiEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = richengxinxiService.selectCount(wrapper);
