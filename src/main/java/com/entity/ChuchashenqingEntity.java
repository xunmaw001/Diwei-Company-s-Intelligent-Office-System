...
public class ChuchashenqingEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public ChuchashenqingEntity() {
		
	}
	
	public ChuchashenqingEntity(T t) {
		try {
	...
	@DateTimeFormat 		
	private Date chuchashijian;
	
	/**
	 * 出差天数
	 */
					
	private Integer chuchatianshu;
	 ...
	 * 设置：出差时间
	 */
	public void setChuchashijian(Date chuchashijian) {
		this.chuchashijian = chuchashijian;
	}
	/**
	 * 获取：出差时间
	 */
	public Date getChuchashijian() {
		return chuchashijian;
	}
	/**
	 * 设置：出差天数
	 */
	public void setChuchatianshu(Integer chuchatianshu) {
		this.chuchatianshu = chuchatianshu;
	}
	/**
	 * 获取：出差天数
	 */
	public Integer getChuchatianshu() {
		return chuchatianshu;
	}
	/**
	 * 设置：申请时间
	 */
