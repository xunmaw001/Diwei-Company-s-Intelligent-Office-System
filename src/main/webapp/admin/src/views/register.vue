  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:10px">
        <h1 class="h1" style="color:rgba(25, 169, 123, 1);fontSize:28px;">地纬公司智能办公系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<!-- <div v-if="tableName=='jingli'" class="input-group">
			   <div class="label">经理工号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.jingligonghao" class="input" type="text" placeholder="经理工号">
			   </div>
			 </div> -->
			<el-form-item label="经理工号" class="input" v-if="tableName=='jingli'">
			  <el-input v-model="ruleForm.jingligonghao" autocomplete="off" placeholder="经理工号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='jingli'" class="input-group">
			...
			<el-form-item label="经理姓名" class="input" v-if="tableName=='jingli'">
			  <el-input v-model="ruleForm.jinglixingming" autocomplete="off" placeholder="经理姓名"  />
			</el-form-item>
			<!-- <div v-if="tableName=='jingli'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='jingli'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<!-- <div v-if="tableName=='jingli'" class="input-group">
			...
			<el-form-item label="电话" class="input" v-if="tableName=='jingli'">
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='jingli'">
			  <el-input v-model="ruleForm.youxiang" autocomplete="off" placeholder="邮箱"  />
			</el-form-item>
			<!-- <div v-if="tableName=='jingli'" class="input-group">
			   <div class="label">身份证</div>
			...
			<el-form-item label="身份证" class="input" v-if="tableName=='jingli'">
			  <el-input v-model="ruleForm.shenfenzheng" autocomplete="off" placeholder="身份证"  />
			</el-form-item>
			<!-- <div v-if="tableName=='jingli'" class="input-group">
			   <div class="label">家庭住址</div>
			...
			<el-form-item label="家庭住址" class="input" v-if="tableName=='jingli'">
			  <el-input v-model="ruleForm.jiatingzhuzhi" autocomplete="off" placeholder="家庭住址"  />
			</el-form-item>
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      if((!this.ruleForm.lianxidianhua) && `yuangong` == this.tableName){
      ...
      if((!this.ruleForm.youxiang) && `yuangong` == this.tableName){
      ...
      if((!this.ruleForm.jingligonghao) && `jingli` == this.tableName){
        this.$message.error(`经理工号不能为空`);
        return
      }
      if((!this.ruleForm.jinglixingming) && `jingli` == this.tableName){
        this.$message.error(`经理姓名不能为空`);
        return
      }
      if((!this.ruleForm.mima) && `jingli` == this.tableName){
        this.$message.error(`密码不能为空`);
        return
      }
      if((!this.ruleForm.dianhua) && `jingli` == this.tableName){
        this.$message.error(`电话不能为空`);
        return
      }
      if(`jingli` == this.tableName && this.ruleForm.dianhua&&(!this.$validate.isMobile(this.ruleForm.dianhua))){
        this.$message.error(`电话应输入手机格式`);
        return
      }
      if((!this.ruleForm.youxiang) && `jingli` == this.tableName){
        this.$message.error(`邮箱不能为空`);
        return
      }
      if(`jingli` == this.tableName && this.ruleForm.youxiang&&(!this.$validate.isEmail(this.ruleForm.youxiang))){
        this.$message.error(`邮箱应输入邮件格式`);
        return
      }
      if((!this.ruleForm.shenfenzheng) && `jingli` == this.tableName){
        this.$message.error(`身份证不能为空`);
        return
      }
      if(`jingli` == this.tableName && this.ruleForm.shenfenzheng&&(!this.$validate.checkIdCard(this.ruleForm.shenfenzheng))){
        this.$message.error(`身份证应输入身份证格式`);
        return
      }
      this.$http({
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20210428/f1500cf7519d4f10bd2ef891369e19bc.png");
		height: 100vh;
