    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="经理工号" prop="jingligonghao">
          <el-input v-model="ruleForm.jingligonghao" 
              placeholder="经理工号" clearable  :readonly="ro.jingligonghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="经理工号" prop="jingligonghao">
              <el-input v-model="ruleForm.jingligonghao" 
                placeholder="经理工号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.jingligonghao!=''&&json.jingligonghao){
              		this.ruleForm.jingligonghao = json.jingligonghao
	    		this.ro.jingligonghao = true;
		}
		if(json.jinglixingming!=''&&json.jinglixingming){
	...
	this.ruleForm.neirong = this.ruleForm.neirong.replace(reg,'../../../ssm7x283/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `richengxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.richengxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
