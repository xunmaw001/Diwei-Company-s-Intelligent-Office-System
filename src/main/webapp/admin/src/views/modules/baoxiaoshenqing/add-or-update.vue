<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="报销金额" prop="baoxiaojine">
          <el-input v-model="ruleForm.baoxiaojine" 
              placeholder="报销金额" clearable  :readonly="ro.baoxiaojine"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="报销金额" prop="baoxiaojine">
              <el-input v-model="ruleForm.baoxiaojine" 
